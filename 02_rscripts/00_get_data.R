...
library("dataverse")
# Colantone, Italo; Livio Di Lonardo; Yotam Margalit; Marco Percoco, 2023,
# "Replication Data for: The Political Consequences of Green Policies:
# Evidence from Italy", https://doi.org/10.7910/DVN/NSC8TJ,
# Harvard Dataverse, V2, UNF:6:RuQPm48kSIo+TzZ84zn8XA== [fileUNF]

replication_data <- 
  get_dataframe_by_name(filename = "Replication_Dataset.tab",
